...
class OldAboutUsModel {
    ...
    class func fetchData() -> OldAboutUsModel {
        ...
        let aboutUsData = OldAboutUsModel(location: location, phoneNumber: phoneNumber, description: description, directionTitle: directionTitle, directionText: directionText, aboutUsIcons: aboutUsIcons)
